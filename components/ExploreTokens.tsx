                ...
                : mappedAttributes.map((attribute, idx, arr) => (
                    ...
                    >
                      <a
                        ...
                        className="flex flex-col rounded-[16px] border border-neutral-200 bg-black p-3 shadow transition hover:-translate-y-0.5 hover:shadow-lg dark:border-neutral-800 dark:bg-black dark:hover:border-neutral-600 lg:p-6"
                      >
