...
function computeTransportConfiguration(initConfiguration, buildEnv) {
    var tags = tags_1.buildTags(initConfiguration);
...
function computeEndpointBuilders(initConfiguration, buildEnv, tags) {
    ...
    var endpointBuilders = {
        logsEndpointBuilder: endpointBuilder_1.createEndpointBuilder(initConfiguration, buildEnv, 'logs', tags),
        rumEndpointBuilder: endpointBuilder_1.createEndpointBuilder(initConfiguration, buildEnv, 'rum', tags),
        sessionReplayEndpointBuilder: endpointBuilder_1.createEndpointBuilder(initConfiguration, buildEnv, 'sessionReplay', tags),
    };
    if (initConfiguration.internalMonitoringApiKey) {
        return tslib_1.__assign(tslib_1.__assign({}, endpointBuilders), { internalMonitoringEndpointBuilder: endpointBuilder_1.createEndpointBuilder(tslib_1.__assign(tslib_1.__assign({}, initConfiguration), { clientToken: initConfiguration.internalMonitoringApiKey }), buildEnv, 'logs', tags, 'browser-agent-internal-monitoring') });
    }
...
function computeReplicaConfiguration(initConfiguration, buildEnv, intakeEndpoints, tags) {
    ...
    var replicaConfiguration = tslib_1.__assign(tslib_1.__assign({}, initConfiguration), { site: endpointBuilder_1.INTAKE_SITE_US, clientToken: initConfiguration.replica.clientToken });
    var replicaEndpointBuilders = {
        logsEndpointBuilder: endpointBuilder_1.createEndpointBuilder(replicaConfiguration, buildEnv, 'logs', tags),
        rumEndpointBuilder: endpointBuilder_1.createEndpointBuilder(replicaConfiguration, buildEnv, 'rum', tags),
        internalMonitoringEndpointBuilder: endpointBuilder_1.createEndpointBuilder(replicaConfiguration, buildEnv, 'logs', tags, 'browser-agent-internal-monitoring'),
    };
