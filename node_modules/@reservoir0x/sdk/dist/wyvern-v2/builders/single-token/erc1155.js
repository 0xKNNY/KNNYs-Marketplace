...
exports.SingleTokenErc1155Builder = void 0;
...
"0x00000000" +
    ...
    // empty `data` (required)
    "0".repeat(128);
class SingleTokenErc1155Builder extends base_1.BaseBuilder {
    constructor(chainId) {
        super(chainId);
        this.buildMatching = (order, taker) => {
    ...
    build(params) {
        ...
        if (params.side === "buy") {
            return new order_1.Order(this.chainId, {
                ...
                calldata: new abi_1.Interface(Erc1155_json_1.default).encodeFunctionData("safeTransferFrom", [constants_1.AddressZero, params.maker, params.tokenId, 1, "0x"]),
...
exports.SingleTokenErc1155Builder = SingleTokenErc1155Builder;
