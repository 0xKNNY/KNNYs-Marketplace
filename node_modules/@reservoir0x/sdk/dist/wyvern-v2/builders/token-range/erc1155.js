...
const erc1155_1 = require("../single-token/erc1155");
...
class TokenRangeErc1155Builder extends base_1.BaseBuilder {
    constructor(chainId) {
        super(chainId);
        this.buildMatching = (order, taker, tokenId) => {
            const tokenIdRange = this.getTokenIdRange(order);
            if (!tokenIdRange) {
                throw new Error("Invalid order");
            }
            if (!((0, utils_1.bn)(tokenIdRange[0]).lte(tokenId) && (0, utils_1.bn)(tokenId).lte(tokenIdRange[1]))) {
                throw new Error("Invalid token id");
            }
            if (order.params.side === Types.OrderSide.BUY) {
                const singleTokenBuilder = new erc1155_1.SingleTokenErc1155Builder(this.chainId);
    ...
    getTokenIdRange(order) {
        try {
            const result = new abi_1.Interface(TokenRangeVerifier_json_1.default).decodeFunctionData("verify", order.params.staticExtradata);
    ...
    build(params) {
        ...
        if (params.side === "buy") {
            return new order_1.Order(this.chainId, {
                ...
                calldata: new abi_1.Interface(Erc1155_json_1.default).encodeFunctionData("safeTransferFrom", [constants_1.AddressZero, params.maker, 0, 1, "0x"]),
